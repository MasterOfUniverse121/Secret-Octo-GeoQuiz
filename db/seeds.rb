Question.create!([
  ...
  {quiz_id: 3, query: "What is a point?", correct_answer: "A dot with 0 dimensions, labeled with a capital letter.", user_answer: nil, author: "1", wrong_answer_1: "A line with two endpoints", wrong_answer_2: "A dot with 1 dimensions all around, labeled with two lowercase letters", wrong_answer_3: "Death's son", answered: nil}
])
Quiz.create!([
